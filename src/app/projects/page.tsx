...
const invitProjects: Project[] = [
  { name: "Barwa Adda–Panagarh", category: "invit", img: "https://emslindia.com/wp-content/uploads/2025/11/Barwa-Adda-to-Panagarh.png" },
  { name: "Thiruvananthapuram", category: "invit", img: "https://emslindia.com/wp-content/uploads/2024/04/sample-image.png" },
  { name: "Pune–Solapur", category: "invit", img: "https://emslindia.com/wp-content/uploads/2024/04/our-projects3.jpg" },
  { name: "Sikar–Bikaner", category: "invit", img: "https://emslindia.com/wp-content/uploads/2024/04/our-projects4.jpg" },
  { name: "Hazaribagh–Ranchi", category: "invit", img: "https://emslindia.com/wp-content/uploads/2024/04/our-projects6.jpg" },
  { name: "Moradabad–Bareilly", category: "invit", img: "https://emslindia.com/wp-content/uploads/2024/04/our-projects5.jpg" },
];

const spvProjects: Project[] = [
  { name: "Ranchi Ring Road", category: "spv", img: "https://emslindia.com/wp-content/uploads/2024/04/our-projects2.jpg" },
  { name: "Jharkhand Road Projects", category: "spv", img: "https://emslindia.com/wp-content/uploads/2025/11/Jharkhand-Road-Projects-1.png" },
  { name: "Chenani–Nashri Tunnelway", category: "spv", img: "https://emslindia.com/wp-content/uploads/2025/11/Chenani–Nashri-Tunnelway-2.png" },
  { name: "RIDCOR– TMS Maintenance (11 Toll Plazas)", category: "spv" },
  { name: "RIDCOR – Toll Collection (4 Toll Plazas)", category: "spv" },
  { name: "Baleshwar–Kharagpur", category: "spv" },
];
...
function ProjectCard({ project }: { project: Project }) {
  return (
    <div className="relative aspect-[4/3] w-full group overflow-hidden cursor-pointer bg-[#8b8b8b] shadow-sm">
      {project.img ? (
        <Image
          src={project.img}
          alt={project.name}
      ...
      <h3 className="absolute bottom-6 left-6 right-6 text-white font-bold text-[22px] z-10 leading-tight transition-transform group-hover:-translate-y-1">
        {project.name}
      </h3>
    </div>
  );
